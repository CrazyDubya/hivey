...
class Config:
    ...
    # LLM Configuration
    DEFAULT_LLM_MODEL: str = os.getenv("DEFAULT_LLM_MODEL", "xai/grok-3-latest")
    ...
    MAX_TASK_DESCRIPTION_LENGTH: int = int(os.getenv("MAX_TASK_DESCRIPTION_LENGTH", "10000"))
    MIN_TASK_DESCRIPTION_LENGTH: int = int(os.getenv("MIN_TASK_DESCRIPTION_LENGTH", "1"))
